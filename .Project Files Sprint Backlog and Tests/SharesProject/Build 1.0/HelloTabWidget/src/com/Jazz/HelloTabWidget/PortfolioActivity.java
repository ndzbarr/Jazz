...
public class PortfolioActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
      ...
      //BP Amoco PLC UNITS: 192
        ...
        textview.append(Html.fromHtml(("<b>[PORTFOLIO TOTAL VALUE]</b><br><br>")));
        //BP AMOCO
        try
        {
	    ...
	    try
	    {
	        ...
	        if (m.find())
	        {
	            ...
	            textview.append(Html.fromHtml(("<b><i>Experian Ord.</i></b><br>192 shares at ")));
        ...
        try
        {
	        ...
	        if (m.find())
	        {
	            ...
	            textview.append(Html.fromHtml(("<b><i>HSBC Holdings</i></b><br>192 shares at ")));
        ...
        try
        {
	        ...
	        if (m.find())
	        {
	            ...
	            textview.append(Html.fromHtml(("<b><i>Marks and Spencer Ord.</i></b><br>192 shares at ")));
        ...
        try
        {
		        ...
		        if (m.find())
		        {
		            ...
		            textview.append(Html.fromHtml(("<b><i>Smith & Nephew PLC</i></b><br>192 shares at ")));
